  ...
  public static byte[] generateVaccinationConfirmation(
    ...
    try (PDDocument document = new PDDocument()) {
      ...
      try (PDPageContentStream contentStream = new PDPageContentStream(document, page)) {
        ...
        try {
          String qrCodeUrl =
              baseUrl + "/" + webapp + "/admin/dashboard.html?tab=tabTermine&id=" + bookingId;
          ...
          contentStream.showText(
              "Bitte zeigen Sie diesen QR-Code bei Ihrer Ankunft im Impfzentrum vor.");
          contentStream.endText();
          ...
          contentStream.showText(
              "Bitte erscheinen Sie pünktlich und bringen Sie einen gültigen Ausweis mit.");
