...
public final class EmailMessageFactory {
    ...
    public static EmailMessage registration(String email, String firstName, String activationUrl) {
        ...
        String body = "Hallo " + firstName + ",\n\n"
            + "vielen Dank für Ihre Registrierung. Bitte aktivieren Sie Ihren Account mit folgendem Link:\n\n"
            + activationUrl + "\n\n"
    ...
    public static EmailMessage bookingConfirmation(
        ...
        String body = "Sehr geehrte(r) " + personName + ",\n\n"
            ...
            + "Impfstoff: " + vaccineType + "\n\n"
            + "Im Anhang finden Sie Ihre Terminbestätigung als PDF.\n\n"
            + "Bitte bringen Sie einen gültigen Ausweis mit und erscheinen Sie pünktlich zum Termin.\n\n"
            + "Mit freundlichen Grüßen,\n"
            + "Ihr Impfterminbuchungsteam";
