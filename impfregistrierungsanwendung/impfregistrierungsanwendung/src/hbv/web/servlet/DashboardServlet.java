...
public class DashboardServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String header = readTemplate("header.html", req)
            ...
            .replace("<!--NAVIGATION-->", "<a href='" + contextPath + "/dashboard'>Dashboard</a> <a href='" + contextPath + "/logout'>Logout</a>");
        ...
        for (int i = 1; i <= 30; i++) {
            ...
            out.println("<option value='" + centerOption + "'" + (centerOption.equals(filterCenter) ? " selected" : "") + ">" + centerOption + "</option>");
        }
        out.println("</select> ");
        ...
        try {
            ...
            if (bookings.isEmpty()) {
                ...
                for (Booking b : bookings) {
                    ...
                    out.println("<td><form method='post' action='cancel'><input type='hidden' name='booking_id' value='" + b.getBookingId() + "'/><input type='submit' value='Stornieren'/></form></td>");
                    out.println("</tr>");
                }
                out.println("</table>");
            }
