...
public class ConfirmationServlet extends HttpServlet {
    private void generatePdf(String inputData, HttpServletResponse resp) throws IOException {
        ...
        try (OutputStream os = process.getOutputStream()) { os.write(inputData.getBytes()); }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        catch (NumberFormatException e) { resp.sendError(HttpServletResponse.SC_BAD_REQUEST, "Ungültige Booking ID"); return; }
        try (Connection conn = Database.getConnection()) {
            String sql = "SELECT u.vorname, u.nachname, u.geburtsdatum, a.date_slot, a.time_slot, a.vaccine, a.location " +
                         "FROM booking b JOIN user_account u ON b.user_id = u.user_id " +
                         "JOIN appointment a ON b.appointment_id = a.appointment_id WHERE b.booking_id = ?";
            ...
            if (rs.next()) {
                ...
                Date dateSlot = rs.getDate("date_slot");
                ...
                String city = "";
                String postalcode = "";
                String starttime = dateSlot.toString() + "T" + timeSlot;
            ...
            } else { resp.sendError(HttpServletResponse.SC_NOT_FOUND, "Buchung nicht gefunden"); }
            rs.close();
            ps.close();
