...
public class UserService implements IUserService {
  ...
  public boolean registerUser(
      String email, String password, String vorname, String nachname, String role, String regCode)
      throws SQLException {
    if (role.equalsIgnoreCase("admin") && !regCode.equals("ADMIN123")) return false;
    if (role.equalsIgnoreCase("center") && !regCode.equals("CENTER123")) return false;
