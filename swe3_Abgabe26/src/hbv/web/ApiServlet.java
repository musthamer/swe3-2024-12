...
public class ApiServlet extends HttpServlet {
    ...
    private void getVaccines(HttpServletRequest request, Map<String, Object> jsonResponse) throws Exception {
    ...
    private void getTimeslots(HttpServletRequest request, Map<String, Object> jsonResponse) throws Exception {
        String centerIdStr = request.getParameter("center_id");
    ...
    private void getVaccineInventory(HttpServletRequest request, Map<String, Object> jsonResponse) throws Exception {
        String centerIdStr = request.getParameter("center_id");
        if (centerIdStr != null) {
            int centerId = Integer.parseInt(centerIdStr);
    ...
    private void getAllCentersStats(HttpServletRequest request, HttpServletResponse response, 
    ...
    private void getCenterStats(HttpServletRequest request, HttpServletResponse response, 
            Map<String, Object> jsonResponse) throws Exception {
        // Implementierung nach Bedarf
    }
    
    private void getAppointments(HttpServletRequest request, Map<String, Object> jsonResponse) throws Exception {
        HttpSession session = request.getSession(false);
        Boolean isLoggedIn = (session != null) ? (Boolean) session.getAttribute("loggedin") : false;
        Integer userId = (session != null) ? (Integer) session.getAttribute("userId") : null;
    ...
    private void postAppointments(HttpServletRequest request, Map<String, Object> jsonResponse) throws Exception {
        HttpSession session = request.getSession(false);
        Boolean isLoggedIn = (session != null) ? (Boolean) session.getAttribute("loggedin") : false;
        Integer userId = (session != null) ? (Integer) session.getAttribute("userId") : null;
        ...
        if ("cancel".equals(action)) {
            ...
            // Bei Erfolg die aktualisierte Terminliste mitsenden (Frontend erwartet appointments)
    ...
    private void bookAppointment(HttpServletRequest request, HttpServletResponse response,
        ...
        if (timeslotId != null && vaccineId != null && firstName != null
                && lastName != null && dateOfBirth != null) {

            int personId = personService.resolvePersonForBooking(
                userId, firstName, lastName, dateOfBirth, forSelf
            );
            ...
            Map<String, Object> bookingResult = bookingService.bookAppointment(
                userId,
    ...
    private void updateVaccineInventory(HttpServletRequest request, Map<String, Object> jsonResponse) throws Exception {
        HttpSession session = request.getSession(false);
        String userRole = (session != null) ? (String) session.getAttribute("userRole") : null;
        ...
        if (userRole != null && userRole.equals("ADMIN")) {
            ...
            if (centerIdStr != null && vaccineIdStr != null && dosesStr != null) {
                VaccineInventoryService inventoryService = new VaccineInventoryService();
                Map<String, Object> result = inventoryService.updateVaccineInventory(
