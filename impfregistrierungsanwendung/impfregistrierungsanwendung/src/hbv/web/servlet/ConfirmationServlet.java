...
public class ConfirmationServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    try (Connection conn = Database.getConnection()) {
      String sql =
          "SELECT u.vorname, u.nachname, u.geburtsdatum, a.date_slot, a.time_slot, a.vaccine,"
              + " a.location FROM booking b JOIN user_account u ON b.user_id = u.user_id JOIN"
              + " appointment a ON b.appointment_id = a.appointment_id WHERE b.booking_id = ?";
