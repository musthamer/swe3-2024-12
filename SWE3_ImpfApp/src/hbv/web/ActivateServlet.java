      ...
      try (Connection connection = ds.getConnection()) {
        ...
        if (rs.next()) {
          ...
          if (expiryTime.before(new java.sql.Timestamp(System.currentTimeMillis()))) {
            ...
            out.println("<p>Ihr Aktivierungscode ist leider abgelaufen. Bitte registrieren Sie sich erneut.</p>");
          ...
          try {
            ...
            PreparedStatement deleteActivation = connection.prepareStatement(
            ...
            out.println("<p>Hallo " + firstName + ", Ihr Account wurde erfolgreich aktiviert. Sie können sich jetzt anmelden.</p>");
