...
doget javase 3.5.2 com/google/zxing compile+runtime

# PDFBox für PDF-Generierung
doget pdfbox 2.0.29 org/apache/pdfbox compile+runtime
doget fontbox 2.0.29 org/apache/pdfbox compile+runtime
doget commons-logging 1.2 commons-logging compile+runtime
