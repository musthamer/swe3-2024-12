...
public class CenterService {
  public void createCenter(String centerName, String centerEmail, String centerPassword)
      throws SQLException {
    try (Connection conn = Database.getConnection()) {
      PreparedStatement psCenter =
          conn.prepareStatement("INSERT INTO vaccine_center (center_name) VALUES (?)");
      ...
      PreparedStatement psAccount =
          conn.prepareStatement(
              "INSERT INTO user_account (email, vorname, nachname, password_hash, role,"
                  + " assigned_center, created_at) VALUES (?,?,?,?,?, ?,CURRENT_TIMESTAMP)");
