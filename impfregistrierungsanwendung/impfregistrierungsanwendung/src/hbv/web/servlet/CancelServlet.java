  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    try (Connection conn = Database.getConnection()) {
      PreparedStatement ps =
          conn.prepareStatement("DELETE FROM booking WHERE booking_id = ? AND user_id = ?");
      ...
      if (affected > 0) {
        ...
        resp.sendError(
            HttpServletResponse.SC_BAD_REQUEST, "Buchung nicht gefunden oder nicht stornierbar.");
      }
