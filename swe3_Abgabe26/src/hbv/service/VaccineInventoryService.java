...
public class VaccineInventoryService {
    ...
    public Map<String, Object> updateVaccineInventory(int centerId, int vaccineId, int addDoses) throws Exception {
        ...
        try (Connection connection = DbUtils.getConnection()) {
            ...
            result.put("message", updated > 0 ? 
                "Impfstoffbestand erfolgreich aktualisiert" : 
                "Impfstoff nicht gefunden");
        }
        return result;
    }
} 