...
public class AdminServlet extends HttpServlet {
  ...
  private void createCenter(HttpServletRequest request, JSONObject jsonResponse) throws Exception {
    ...
    jsonResponse.put("message", success ? "Impfzentrum wurde erfolgreich erstellt" : "Fehler beim Erstellen des Impfzentrums");
  }
  
  private void updateInventory(HttpServletRequest request, JSONObject jsonResponse) throws Exception {
    String centerIdStr = request.getParameter("center_id");
    ...
    jsonResponse.put("success", success);
    jsonResponse.put("message", success ? "Impfbestand wurde erfolgreich aktualisiert" : "Fehler beim Aktualisieren des Impfbestands");
  }

  private void completeAppointment(HttpServletRequest request, JSONObject jsonResponse) throws Exception {
    ...
    jsonResponse.put("success", success);
    jsonResponse.put("message", success ? "Termin erfolgreich als durchgeführt markiert" : "Termin konnte nicht aktualisiert werden");
  }
} 