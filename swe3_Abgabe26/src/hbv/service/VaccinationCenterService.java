    ...
    public List<Map<String, Object>> getAllCentersStatistics() throws Exception {
        ...
        try (Connection connection = DbUtils.getConnection()) {
            ...
            while (rs.next()) {
                ...
                PreparedStatement bookingStats = connection.prepareStatement(
                ...
                PreparedStatement availableSlotsPs = connection.prepareStatement(
                    "SELECT COUNT(*) AS available_slots FROM timeslot t " +
                    "WHERE t.center_id = ? AND t.capacity > " +
                    "(SELECT COUNT(*) FROM booking b WHERE b.timeslot_id = t.id AND b.status = 'CONFIRMED') " +
                ...
                PreparedStatement totalSlotsPs = connection.prepareStatement(
                    "SELECT SUM(capacity) AS total_capacity FROM timeslot WHERE center_id = ? AND start_time > NOW()"
                );
                ...
                PreparedStatement vaccineStats = connection.prepareStatement(
    ...
    public Map<String, Object> getCenterStatistics(int centerId) throws Exception {
        ...
        try (Connection connection = DbUtils.getConnection()) {
            ...
            if (rs.next()) {
                ...
                PreparedStatement currentBookingsPs = connection.prepareStatement(
                ...
                while (currentBookingsRs.next()) {
                    ...
                    booking.put("patientName", currentBookingsRs.getString("first_name") + " " + 
